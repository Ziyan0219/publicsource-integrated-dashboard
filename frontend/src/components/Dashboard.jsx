  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="flex items-center space-x-4">
              <Link 
                to="/keyword-search" 
                className="flex items-center space-x-2 px-6 py-3 text-gray-700 bg-gray-100 rounded-xl border-2 border-gray-200 font-semibold hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700"
              >
              ...
              <button
                onClick={onLogout}
                className="flex items-center space-x-2 px-6 py-3 text-red-700 bg-red-50 rounded-xl border-2 border-red-200 font-semibold hover:bg-red-100 hover:border-red-300"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-200">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-4 py-4 text-lg border-2 border-gray-300 rounded-xl bg-gray-50 font-medium focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                />
              </div>
            </div>
            ...
            <button
              ...
              className={`flex items-center justify-center space-x-3 px-8 py-4 rounded-xl border-2 font-bold min-w-[160px] shadow-lg ${
        ...
        <div className="mb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 shadow-xl border-2 border-blue-700 text-white">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 shadow-xl border-2 border-green-700 text-white">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 shadow-xl border-2 border-orange-700 text-white">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 shadow-xl border-2 border-purple-700 text-white">
            <div className="flex items-center justify-between">
              <div>
        ...
        {filteredStories.length === 0 && (
          <div className="text-center py-16 bg-white rounded-2xl shadow-xl border-2 border-gray-200">
            ...
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold text-lg shadow-lg border-2 border-blue-700"
            >
              Clear all filters
            </button>
          </div>
